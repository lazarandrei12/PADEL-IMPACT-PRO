      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-8 py-5 bg-[#050a14]/80 backdrop-blur-md border-b border-white/5">
        ...
        <div className="hidden md:flex gap-6 items-center">
          ...
          <div className="flex flex-col items-center gap-0.5">
            <button className="text-xs tracking-[0.2em] uppercase border border-[#3b82f6]/50 text-[#3b82f6] px-5 py-2 hover:bg-[#3b82f6] hover:text-white transition-all duration-300">
              Wishlist
            </button>
            <span className="text-white/40 text-[8px] tracking-[0.1em]">Coming Soon</span>
          </div>
        </div>
        ...
        {menuOpen && (
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}
            ...
            <div className="flex flex-col items-center gap-1 mt-4">
              <button className="mt-4 text-sm tracking-[0.2em] uppercase border border-[#3b82f6]/50 text-[#3b82f6] px-8 py-4 hover:bg-[#3b82f6] hover:text-white transition-all duration-300">
                Wishlist on Steam
              </button>
              <span className="text-white/40 text-xs tracking-[0.1em]">Coming Soon</span>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <section ref={heroRef} id="game" className="relative h-[100svh] overflow-hidden flex items-center justify-center">
        ...
        <motion.div style={{ y: logoY, opacity: logoOpacity }}
          ...
          <motion.div
            ...
            <button className="w-full md:w-auto flex flex-col items-center gap-1 bg-[#3b82f6] text-white text-xs tracking-[0.2em] uppercase px-8 py-4 md:py-3.5 hover:bg-[#2563eb] transition-all duration-300 hover:shadow-[0_0_30px_rgba(59,130,246,0.5)]">
              <span>Add to Wishlist</span>
              <span className="text-white/60 text-[10px] tracking-[0.05em]">Coming Soon</span>
            </button>
